    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('code', models.CharField(max_length=10, unique=True)),
                ('favourite', models.ManyToManyField(blank=True, related_name='favourite_fx', to=settings.AUTH_USER_MODEL)),
                ...
                ('to_currency', models.ForeignKey(default=2, on_delete=django.db.models.deletion.CASCADE, related_name='to_currency', to='trading.Currency')),
            ],
            options={
                'db_table': 'fx_pair',
            },
